...
<div class="mx-auto max-w-2xl rounded border border-gray-200 bg-white p-5">
    <h2 class="mb-4 text-lg font-semibold">Nova categoria</h2>
    <form method="POST" action="{{ route('categorias.store') }}">
        @csrf
        @include('categorias._form')
        <div class="mt-5 flex items-center gap-2">
            <button class="rounded bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700">Salvar</button>
